...
<ul id="dropdown2" class="dropdown-content">
  ...
  <li class="divider"></li>
  <li><a href="{{ url('/seleccionarProductos') }}"> Actualizar y/o Eliminar Producto </a></li>
  <li class="divider"></li>
...
{{--NAV--}}
  ...
  <a href="#!" class=""><img style="width: 4.2%; height: 4.2%;margin-left: 9px;" src="logo7.png"> Marmolerias Torreon</a>
