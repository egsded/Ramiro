...
<body style="background-color: #7777">
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{url("/logiado")}}">
          {{csrf_field()}}
        ...
        <div class="form-group">
          <label for="nombreinput">Contraseña:</label>
          <input name="contraseña" type="password" class="form-control" id="contraseña" placeholder="*****">
        </div>
