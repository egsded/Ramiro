...
<ul id="dropdown1" class="dropdown-content">
  ...
  <li class="divider"></li>
  <li> <a href="{{ url('/clientesingresados') }}"> Historial de registro de Clientes </a></li>
  <li class="divider"></li>
  <li> <a href="{{ url('/clientesborrados') }}"> Clientes Borrados </a></li>
  <li class="divider"></li>
  <li> <a href="{{ url('/clientesmodificados') }}"> Clientes Modificados</a></li>
</ul>
...
<ul id="dropdown2" class="dropdown-content">
  ...
  <li class="divider"></li>
  <li> <a href="{{ url('/verprodcutosporfecha') }}"> Historial de registro de Productos</a></li>
 </ul>
...
@if(Session::has('usuario') && Session::get("usuario")->tipo == 1)
