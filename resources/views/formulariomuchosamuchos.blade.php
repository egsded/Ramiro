    ...
    <div class="card">
      ...
      <div class="card-body">
          ...
          <div class="form-group">
            ...
            <div class="col.sm-8">
              <select name="idcontacto" id="inputID" class="form-control">
                ...
                <option value="{{$contacto->id}}" @if(old('id')==$contacto->id)selected="true" @endif>{{$contacto->Cliente}}</option>
                @endforeach
              </select>
            </div>
          </div>
          <div class="form-group">
            <label for="inputID" class="col-sm-4 control-label">Carro:</label>
            <div class="col.sm-8">
              <select name="idcarro" id="inputID" class="form-control">
        ...
        @if(Session::has("status"))
          ...
          <div>
            <strong>Se agregó el carro de::{{Session::get("contacto")->nombre}} de la marca::{{Session::get("contacto")->carros}}</strong>
          </div>
          @endif
        @endif
