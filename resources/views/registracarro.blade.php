...
<body style="background-color: #7777">
  ...
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        <form method="POST" action="{{url("/altacarrito")}}">
          {{csrf_field()}}
          <div class="form-group">
          <label for="marca">Marca:</label>
          <input name="marca" type="text" class="form-control" id="marca" placeholder="mazda">
        </div>
        <div class="form-group">
          <label for="modelo">Modelo:</label>
          <input name="modelo" type="text" class="form-control" id="modelo" placeholder="focus">
        </div>
